...
int main()
{
    ...
    // cin >> ip;
    // cout << "Enter the CIDR value" << endl;
    // cin >> cidr;
    ...
    cout<<"Number of Total Adresses : 65536"<<endl;
    cout<<"Number of Alloted Adresses : 40960"<<endl;
    cout<<"Number of balance addresses : "<<(pow(2,16)-cal)<<endl;
    return 0;
}